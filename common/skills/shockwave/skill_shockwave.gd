...
func _check_hits()->void:
	...
	for result in results:
		...
		var knockback_speed: float = knockback_distance / effect_duration  # 距离/时间=速度
		body.add_buff(KnockbackBuffDefinition.new(knockback_speed, effect_duration), _caster, {"direction": dir})
